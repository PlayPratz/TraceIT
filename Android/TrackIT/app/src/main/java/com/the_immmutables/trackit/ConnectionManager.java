...
public class ConnectionManager {
	...
	public static final String URL = "http://192.168.43.149:8081";
	...
	public static void syncData(final String requestBody, RequestQueue requestQueue, String URL, final VolleyCallback volleyCallback) {
